...
/* harmony import */ var ng_zorro_antd_layout__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ng-zorro-antd/layout */ "./node_modules/ng-zorro-antd/fesm5/ng-zorro-antd-layout.js");
/* harmony import */ var ng_zorro_antd_upload__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ng-zorro-antd/upload */ "./node_modules/ng-zorro-antd/fesm5/ng-zorro-antd-upload.js");
/* harmony import */ var ng_zorro_antd_table__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ng-zorro-antd/table */ "./node_modules/ng-zorro-antd/fesm5/ng-zorro-antd-table.js");
/* harmony import */ var ng_zorro_antd_spin__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ng-zorro-antd/spin */ "./node_modules/ng-zorro-antd/fesm5/ng-zorro-antd-spin.js");
...
/* harmony import */ var ng_zorro_antd_button__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ng-zorro-antd/button */ "./node_modules/ng-zorro-antd/fesm5/ng-zorro-antd-button.js");
/* harmony import */ var ng_zorro_antd_select__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ng-zorro-antd/select */ "./node_modules/ng-zorro-antd/fesm5/ng-zorro-antd-select.js");
/* harmony import */ var ng_zorro_antd_switch__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ng-zorro-antd/switch */ "./node_modules/ng-zorro-antd/fesm5/ng-zorro-antd-switch.js");
/* harmony import */ var ng_zorro_antd_mention__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ng-zorro-antd/mention */ "./node_modules/ng-zorro-antd/fesm5/ng-zorro-antd-mention.js");
/* harmony import */ var ng_zorro_antd_empty__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ng-zorro-antd/empty */ "./node_modules/ng-zorro-antd/fesm5/ng-zorro-antd-empty.js");
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var ng_zorro_antd_message__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ng-zorro-antd/message */ "./node_modules/ng-zorro-antd/fesm5/ng-zorro-antd-message.js");
...
var AppComponent = /** @class */ (function () {
    ...
    AppComponent.prototype.mappingCategories = function () {
        this.category1SuggestionsData = this.subCategory1Data.map(function (data) { return data.label; });
        this.category2SuggestionsData = this.subCategory2Data.map(function (data) { return data.label; });
    };
    ...
    AppComponent.prototype.categorizeStore = function () {
        var _this = this;
        this._resetForm();
        ...
        var intervalHandle = setInterval(function () {
            var category1 = _this._index++ % _this.category1SuggestionsData.length;
            _this.selectedSubCategory1 = _this.category1SuggestionsData[category1];
            var category2 = _this._index++ % _this.category2SuggestionsData.length;
            _this.selectedSubCategory2 = _this.category2SuggestionsData[category2];
        }, 50);
        setTimeout(function () {
            clearInterval(intervalHandle);
            if (_this.store.includes('warung')) {
                _this.categoryNotFound = true;
                _this.categoryNotFoundErrorMessage =
            ...
            _this.isDisabledSwitcher = false;
        }, 3000);
    };
    AppComponent.prototype._resetForm = function () {
        this.hasSearched = false;
        this.categoryNotFound = false;
        this.categoryNotFoundErrorMessage = '';
        this.createManual = false;
    };
    AppComponent.prototype._shuffle = function (array) {
    ...
    AppComponent.prototype.createManualStore = function () {
        this.createManual = true;
        this.validateForm.controls['name'].setValue(this.store);
    };
    AppComponent.prototype.handleChange = function (info) {
        var _this = this;
        ...
        if (status === 'done') {
            ...
            this.isDone = true;
            this.isDisabledSwitcher = false;
            this._getFileBuffer(info.file.originFileObj, function (file) {
                _this.handleExcel(file);
            });
    ...
    AppComponent.prototype._getFileBuffer = function (file, callback) {
        var reader = new FileReader();
        reader.addEventListener('load', function () { return callback(reader.result); });
        reader.readAsArrayBuffer(file);
    };
    AppComponent.prototype.handleExcel = function (bstr) {
        var buffer = new Uint8Array(bstr);
        var wb = xlsx__WEBPACK_IMPORTED_MODULE_3__["read"](buffer, { type: 'array' });
        /* grab first sheet */
    ...
    AppComponent.prototype.readDataSheet = function (ws, startRow) {
        var _this = this;
        /* save data */
        var datas = (xlsx__WEBPACK_IMPORTED_MODULE_3__["utils"].sheet_to_json(ws, { header: 1, raw: false, range: startRow }));
        var headDatas = datas[0];
        datas = datas.slice(1); // remove first header record
        var _loop_1 = function (i) {
            this_1.data[i][this_1.headData.length] = datas.filter(function (x) { return x[12] == _this.data[i][0]; });
        };
        var this_1 = this;
...
/* harmony import */ var ng_zorro_antd_form__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ng-zorro-antd/form */ "./node_modules/ng-zorro-antd/fesm5/ng-zorro-antd-form.js");
